...
export const PROJECTS: Project[] = [
  {
    ...
    description: "Full-floor sky residences with a private arrival lobby, wrapped in bronze-tinted glass above the marina.",
  },
  {
    slug: "serena-courtyard",
    name: "Serena Courtyard",
    ...
    description: "A single-storey villa arranged around a moonlit reflecting pool, entered across floating stone.",
  },
  {
    slug: "meridian-cliff",
    name: "Meridian Cliff",
    location: "Al Zoha Coast, Oman",
    price: "From $11.8M",
    beds: 5,
    baths: 6,
    area: "980 m²",
    ...
    description: "Cantilevered over the Arabian Sea, with a glass-edge pool suspended forty metres above the surf.",
  },
  {
    slug: "lumen-tower",
    ...
    description: "Penthouse duplexes crowned by a private observatory lounge, in the quiet heart of the capital.",
  },
  {
    slug: "vela-courtyard",
    name: "Vela Gardens",
    location: "Palm Crescent, Dubai",
    price: "From $18.5M",
    beds: 7,
    baths: 9,
    area: "1,720 m²",
    ...
    description: "Seven-bedroom beachfront estate with a 40-metre courtyard pool aligned to the setting sun.",
  },
  {
    slug: "solace-cliff",
    name: "Solace Point",
    ...
    description: "A cliff-top retreat carved into the fjords, where every room faces the open water.",
  },
];
